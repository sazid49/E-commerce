                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            @foreach ($categories as $category)
                                @php
                                    $subcategories = \App\Models\backend\SubCategory::query()
                                ...
                                <li class="hassubs">
                                    ...
                                    <ul>
                                        @foreach ($subcategories as $subcategory)
                                            @php
                                                $childcategories = \App\Models\backend\ChildCategory::query()
                    ...
                    <div class="main_nav_menu ml-auto">
                        <ul class="standard_dropdown main_nav_dropdown">
                            ...
                            <li><a href="#">Campaign Us<i class="fas fa-chevron-down"></i></a></li>
                            <li><a href="#">Helfline<i class="fas fa-chevron-down"></i></a></li>
